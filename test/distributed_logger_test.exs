defmodule DistributedLoggerTest do
  ...
  defp read_events_node(node) do
    :rpc.block_call(:"#{node}@127.0.0.1", Helpers, :get_event_logs, [])
  end

  defp handle_timestamp(result) do
    {timestamp, data} =
      String.split(result)
      |> List.pop_at(0)
  ...
  test "should write events in order" do
    ...
    [first, second, third, fourth, _] = read_events_node("node1")
  ...
  test "should write only inside node" do
    ...
    [first, _] = read_events_node("node1")
    [second, _] = read_events_node("node3")
  ...
  test "should write with timestamp on all nodes in order" do
    ...
    [first1, second1, third1, fourth1, fifth1, sixth1, _] = read_events_node("node1")
    [first2, second2, third2, fourth2, fifth2, sixth2, _] = read_events_node("node2")
    [first3, second3, third3, fourth3, fifth3, sixth3, _] = read_events_node("node3")
    ...
    assert timestamp_first_1 == timestamp_first_2
    assert timestamp_first_1 == timestamp_first_3
    ...
    assert timestamp_second_1 == timestamp_second_2
    assert timestamp_second_1 == timestamp_second_3
    ...
    assert timestamp_third_1 == timestamp_third_2
    assert timestamp_third_1 == timestamp_third_3
    ...
    assert timestamp_fourth_1 == timestamp_fourth_2
    assert timestamp_fourth_1 == timestamp_fourth_3
    ...
    assert timestamp_fifth_1 == timestamp_fifth_2
    assert timestamp_fifth_1 == timestamp_fifth_3
    ...
    assert timestamp_sixth_1 == timestamp_sixth_2
    assert timestamp_sixth_1 == timestamp_sixth_3
  end
end
